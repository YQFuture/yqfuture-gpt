...
func (m *defaultTsGoodsLogModel) Insert(ctx context.Context, data *TsGoodsLog) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Id, data.ShopLogId, data.GoodsId, data.TrainingResult, data.Token, data.Power, data.FileSize, data.StartTime, data.EndTime, data.CreateBy, data.UpdateBy)
	return ret, err
}
...
func (m *defaultTsGoodsLogModel) Update(ctx context.Context, data *TsGoodsLog) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.ShopLogId, data.GoodsId, data.TrainingResult, data.Token, data.Power, data.FileSize, data.StartTime, data.EndTime, data.CreateBy, data.UpdateBy, data.Id)
	return err
}
